...
class Command(BaseCommand):
    ...
    def ResolveBattle(self, oRs):
        ...
        for friend in friendsArray:
            battle.SetFriend(friend[0], friend[1])

...
class View(GlobalView):
    ...
    def displayUpkeep(self):
        ...
        content = GetTemplate(self.request, "upkeep")
        ...
        query = "SELECT scientists,soldiers,planets,ships_signature,ships_in_position_signature,ships_parked_signature," + \
                ...
                " int4(upkeep_scientists + scientists*cost_scientists/24*"+hours+"),"+ \
                " int4(upkeep_soldiers + soldiers*cost_soldiers/24*"+hours+"),"+ \
                " int4(upkeep_planets + cost_planets2/24*"+hours+"),"+ \
                " int4(upkeep_ships + ships_signature*cost_ships/24*"+hours+"),"+ \
                " int4(upkeep_ships_in_position + ships_in_position_signature*cost_ships_in_position/24*"+hours+"),"+ \
                " int4(upkeep_ships_parked + ships_parked_signature*cost_ships_parked/24*"+hours+"),"+ \
                " commanders, commanders_salary, cost_commanders, upkeep_commanders + int4(commanders_salary*cost_commanders/24*"+hours+")" + \
